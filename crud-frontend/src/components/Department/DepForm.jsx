                            ...
                            getDep.map((department) => {
                                return (
                                    <tr className='d-tr'>
                                        ...
                                        <td className='d-td'><button className='d-edit' onClick={(e) => handleEditClick(e, department.department_id)}>✏️</button><button className='d-delete'>❌</button></td>
                                    </tr>
                                )
                            })
                        }
